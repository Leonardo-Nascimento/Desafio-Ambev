...
# Define a string de conexão e executa as migrações
ENV ConnectionStrings__DefaultConnection="Server=sqlserver;Database=DeveloperEvaluation;User Id=sa;Password=123@store;TrustServerCertificate=true"
ENTRYPOINT ["dotnet", "ef", "database", "update", "--startup-project", "."]
ENTRYPOINT dotnet ef database update --environment Development --project src/Ambev.DeveloperEvaluation.ORM
