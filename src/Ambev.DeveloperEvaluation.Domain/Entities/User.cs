...
public class User : BaseEntity, IUser
{
    ...
    public User(long id, string email, string phone, string password, UserRole role, UserStatus status, string username)
    {
        SetId(id);
        Email = email;
        Phone = phone;
    ...
    public User(string email, string phone, string password, UserRole role, UserStatus status, string username)
    {
